		...
		graphics::mainRunLoop(Window, [&]()
			{
				...
				std::vector<Real> ParticlesPos(EulerParticleSize * 3);
				std::vector<Real> ParticlesVel(EulerParticleSize * 3);
				//MPhysicsAPI::copyPositionToCPU("TestSimulator", ParticlesPos.data());
				//MPhysicsAPI::copyVelToCPU("TestSimulator", ParticlesVel.data());
				MPhysicsAPI::copyEulerParticlesPosToCPU("TestSimulator", ParticlesPos.data());
				MPhysicsAPI::copyEulerParticlesVelToCPU("TestSimulator", ParticlesVel.data());
				drawParticles(ParticlesPos, ParticlesVel, Model, View, Projection);
