...
class CFaceCenteredVectorField final : public CFaceCenteredVectorGrid, public CVectorField
{
public:
	...
	CFaceCenteredVectorField(const CFaceCenteredVectorField& vOther);
	~CFaceCenteredVectorField();
	...
	(
		...
		ESamplingAlgorithm vSamplingAlg = ESamplingAlgorithm::TRILINEAR
	) const;
