...
class CMixPICAndFLIP : public CAdvectionSolver
{
public:
	CMixPICAndFLIP();
	CMixPICAndFLIP
...
private:
	...
	thrust::device_vector<Real> m_TempParticlesPICVel;
...
typedef std::shared_ptr<CMixPICAndFLIP> MixPICAndFLIPSolverPtr;
